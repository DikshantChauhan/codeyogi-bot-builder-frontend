...
import { fetchCampaignsListSaga, fetchCampaignDetailsSaga } from './campaign.saga'
...
function* campaignListPageSaga(_: PathMatch<string>) {
  yield fetchCampaignsListSaga(_)
  yield fetchMetaSaga()
}

const sagasByPath = {
  [ROUTE_CAMPAIGNS_LIST]: campaignListPageSaga,
  [ROUTE_CAMPAIGN_DETAILS()]: fetchCampaignDetailsSaga,
