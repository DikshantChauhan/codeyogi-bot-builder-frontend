...
export default function Home() {
  const { flows, initLoading, addFlow } = useFlowStore((state) => ({
    flows: state.flows,
  ...
  return (
    <div className="p-4 sm:p-8 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0 mb-8 sm:mb-12">
        ...
        <button
          onClick={() => setIsFlowFormOpen(true)}
              ...
              {flows
                ...
                .map((flow) => (
                  <Link
                    ...
                    className="block p-3 sm:p-4 border border-gray-200 rounded-lg hover:border-blue-400 hover:shadow-md transition-all duration-200"
                  >
