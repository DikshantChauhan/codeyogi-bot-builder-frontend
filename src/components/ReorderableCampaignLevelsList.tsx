...
import { flowsByIdsSelector } from '../store/selectors/flow.selector'
...
const ReorderableCampaignLevelsList = ({ campaignId, levelsIds, setLevelsIds, flowsByIds }: Props) => {
...
export default memo(connect(mapStateToProps)(ReorderableCampaignLevelsList))
